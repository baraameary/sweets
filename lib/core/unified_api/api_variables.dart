...
class ApiVariables {
  ...
  Uri showTypesOfClassifyByID(String id) =>
      _mainUri(path: 'type_of_classifys/$id');
  Uri typesOfClassifyByID(String id) =>
      _mainUri(path: 'type_of_classifys', queryParameters: {'plant': id});
